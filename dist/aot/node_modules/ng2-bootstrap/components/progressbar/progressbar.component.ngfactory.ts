...
export class Wrapper_ProgressbarComponent {
  ...
  constructor() {
    this.changed = false;
    this._animate = import1.UNINITIALIZED;
  ...
  check_animate(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._animate,currValue))) {
      this.changed = true;
      this.context.animate = currValue;
      this._animate = currValue;
    }
  }
...
class _View_ProgressbarComponent_Host0 extends import3.AppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = this.selectOrCreateHostElement('progressbar',rootSelector,(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this._ProgressbarComponent_0_4.detectChangesInternal(this,this._el_0,throwOnChange);
...
class _View_ProgressbarComponent0 extends import3.AppView<import0.ProgressbarComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_1,'progress','');
    this._ProgressDirective_1_3 = new import10.Wrapper_ProgressDirective();
    this._text_2 = this.renderer.createText(this._el_1,'\n      ',(null as any));
    this._el_3 = this.renderer.createElement(this._el_1,'bar',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this.context.animate;
    this._ProgressDirective_1_3.check_animate(currVal_0,throwOnChange,false);
    const currVal_1:any = this.context.max;
    this._ProgressDirective_1_3.check_max(currVal_1,throwOnChange,false);
    this._ProgressDirective_1_3.detectChangesInternal(this,this._el_1,throwOnChange);
    const currVal_4:any = this.context.type;
    this._BarComponent_3_4.check_type(currVal_4,throwOnChange,false);
    const currVal_5:any = this.context.value;
    this._BarComponent_3_4.check_value(currVal_5,throwOnChange,false);
    this._BarComponent_3_4.detectChangesInternal(this,this._el_3,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_2:any = this._ProgressDirective_1_3.context.max;
    if (import2.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementAttribute(this._el_1,'max',((currVal_2 == (null as any))? (null as any): currVal_2.toString()));
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = this._ProgressDirective_1_3.context.addClass;
    if (import2.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setElementClass(this._el_1,'progress',currVal_3);

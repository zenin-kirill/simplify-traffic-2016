...
export class Wrapper_AccordionComponent {
  ...
  changed:boolean;
  /*private*/ _closeOthers:any;
  constructor() {
    this.changed = false;
    this._closeOthers = import1.UNINITIALIZED;
  ...
  check_closeOthers(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._closeOthers,currValue))) {
      this.changed = true;
      this.context.closeOthers = currValue;
      this._closeOthers = currValue;
    }
  }
...
class _View_AccordionComponent_Host0 extends import3.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this._AccordionComponent_0_4.detectChangesInternal(this,this._el_0,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = this._AccordionComponent_0_4.context.addClass;
    if (import2.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementClass(this._el_0,'panel-group',currVal_0);

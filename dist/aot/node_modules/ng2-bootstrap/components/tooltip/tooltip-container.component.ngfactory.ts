...
class _View_TooltipContainerComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('tooltip-container',rootSelector,(null as any));
...
class _View_TooltipContainerComponent0 extends import1.AppView<import0.TooltipContainerComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = 'tooltip';
    this._NgClass_0_3.check_klass(currVal_0,throwOnChange,false);
    const currVal_1:any = this.context.classMap;
    ...
    const currVal_2:any = this._map_0(this.context.top,this.context.left,this.context.display);
    ...
    const currVal_3:any = (this.context.htmlContent && !this.context.isTemplate);
    ...
    const currVal_4:any = (this.context.htmlContent && this.context.isTemplate);
    ...
    const currVal_5:any = this.context.content;
...
class _View_TooltipContainerComponent1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import4.interpolate(1,'',this.parent.context.htmlContent,'');
...
class _View_TooltipContainerComponent2 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this._map_0(this.parent.context.context);
    this._NgTemplateOutlet_2_6.check_ngOutletContext(currVal_0,throwOnChange,false);
    const currVal_1:any = this.parent.context.htmlContent;

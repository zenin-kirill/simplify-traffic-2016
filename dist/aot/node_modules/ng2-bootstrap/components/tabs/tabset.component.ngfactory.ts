...
export class Wrapper_TabsetComponent {
  ...
  /*private*/ _justified:any;
  /*private*/ _type:any;
  constructor() {
    this.changed = false;
    this._vertical = import1.UNINITIALIZED;
    this._justified = import1.UNINITIALIZED;
  ...
  check_vertical(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._vertical,currValue))) {
      this.changed = true;
      this.context.vertical = currValue;
      this._vertical = currValue;
    }
  }
  check_justified(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._justified,currValue))) {
      this.changed = true;
      this.context.justified = currValue;
      this._justified = currValue;
    }
  }
...
class _View_TabsetComponent_Host0 extends import3.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this._TabsetComponent_0_4.detectChangesInternal(this,this._el_0,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = this._TabsetComponent_0_4.context.clazz;
...
class _View_TabsetComponent0 extends import3.AppView<import0.TabsetComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_1,'class','nav');
    ...
    this.renderer.setElementAttribute(this._el_6,'class','tab-content');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._NgClass_1_3.check_klass(currVal_1,throwOnChange,false);
    const currVal_2:any = this.context.classMap;
    this._NgClass_1_3.check_ngClass(currVal_2,throwOnChange,false);
    this._NgClass_1_3.detectChangesInternal(this,this._el_1,throwOnChange);
    const currVal_3:any = this.context.tabs;
    this._NgFor_3_6.check_ngForOf(currVal_3,throwOnChange,false);
...
class _View_TabsetComponent1 extends import3.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_6:any = this.context.$implicit.headingRef;
    this._NgTranscludeDirective_4_5.check_ngTransclude(currVal_6,throwOnChange,false);
    this._NgTranscludeDirective_4_5.detectChangesInternal(this,this._el_4,throwOnChange);
    const currVal_8:any = this.context.$implicit.removable;
    this._NgIf_7_6.check_ngIf(currVal_8,throwOnChange,false);
    this._NgIf_7_6.detectChangesInternal(this,this._anchor_7,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import2.interpolate(1,'nav-item ',this.context.$implicit.customClass,'');
    if (import2.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
    ...
    if (import2.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementClass(this._el_0,'disabled',currVal_2);
      this._expr_2 = currVal_2;
    }
    const currVal_4:any = this.context.$implicit.active;
    ...
    const currVal_5:any = this.context.$implicit.disabled;
    if (import2.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this.renderer.setElementClass(this._el_2,'disabled',currVal_5);
      this._expr_5 = currVal_5;
    }
    const currVal_7:any = import2.interpolate(1,'',this.context.$implicit.heading,'');
  ...
  private _handle_click_2_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>(this.context.$implicit.active = true)) !== false);
    return (true && pd_0);
  }
}
...
class _View_TabsetComponent2 extends import3.AppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_2,'class','glyphicon glyphicon-remove-circle');
  ...
  private _handle_click_2_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.parent.parent.context.removeTab(this.parent.context.$implicit)) !== false);
    return (true && pd_0);
  }
}

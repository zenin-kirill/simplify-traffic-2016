...
export class Wrapper_SlideComponent {
  ...
  constructor(p0:any) {
    this.changed = false;
    this._index = import1.UNINITIALIZED;
    this._direction = import1.UNINITIALIZED;
  ...
  check_index(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._index,currValue))) {
      this.changed = true;
      this.context.index = currValue;
      this._index = currValue;
    }
  }
  check_direction(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import2.checkBinding(throwOnChange,this._direction,currValue))) {
      this.changed = true;
      this.context.direction = currValue;
      this._direction = currValue;
    }
  }
...
class _View_SlideComponent_Host0 extends import3.AppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = this.selectOrCreateHostElement('slide',rootSelector,(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this._SlideComponent_0_4.detectChangesInternal(this,this._el_0,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = this._SlideComponent_0_4.context.active;
    ...
    const currVal_1:any = this._SlideComponent_0_4.context.addClass;
    if (import2.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementClass(this._el_0,'item',currVal_1);
      this._expr_1 = currVal_1;
    }
    const currVal_2:any = this._SlideComponent_0_4.context.addClass;
    if (import2.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementClass(this._el_0,'carousel-item',currVal_2);
...
class _View_SlideComponent0 extends import3.AppView<import0.SlideComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_1,'class','item');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import2.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementClass(this._el_1,'active',currVal_0);
      this._expr_0 = currVal_0;
    }
    this.detectViewChildrenChanges(throwOnChange);
  }

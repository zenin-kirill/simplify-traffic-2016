...
class _View_DatePickerComponent_Host0 extends import3.AppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = this.selectOrCreateHostElement('datepicker',rootSelector,(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this._DatePickerComponent_0_5.detectChangesInternal(this,this._el_0,throwOnChange);
...
class _View_DatePickerComponent0 extends import3.AppView<import0.DatePickerComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this._el_1 = this.renderer.createElement(parentRenderNode,'datepicker-inner',(null as any));
    ...
    this._el_3 = this.renderer.createElement((null as any),'daypicker',(null as any));
    this.renderer.setElementAttribute(this._el_3,'tabindex','0');
    ...
    this._el_5 = this.renderer.createElement((null as any),'monthpicker',(null as any));
    ...
    this._el_7 = this.renderer.createElement((null as any),'yearpicker',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = this.context.datepickerMode;
    this._DatePickerInnerComponent_1_4.check_datepickerMode(currVal_2,throwOnChange,false);
    const currVal_3:any = this.context.startingDay;
    this._DatePickerInnerComponent_1_4.check_startingDay(currVal_3,throwOnChange,false);
    const currVal_4:any = this.context.yearRange;
    this._DatePickerInnerComponent_1_4.check_yearRange(currVal_4,throwOnChange,false);
    const currVal_5:any = this.context.minDate;
    this._DatePickerInnerComponent_1_4.check_minDate(currVal_5,throwOnChange,false);
    const currVal_6:any = this.context.maxDate;
    this._DatePickerInnerComponent_1_4.check_maxDate(currVal_6,throwOnChange,false);
    const currVal_7:any = this.context.minMode;
    this._DatePickerInnerComponent_1_4.check_minMode(currVal_7,throwOnChange,false);
    const currVal_8:any = this.context.maxMode;
    this._DatePickerInnerComponent_1_4.check_maxMode(currVal_8,throwOnChange,false);
    const currVal_9:any = this.context.showWeeks;
    this._DatePickerInnerComponent_1_4.check_showWeeks(currVal_9,throwOnChange,false);
    const currVal_10:any = this.context.formatDay;
    this._DatePickerInnerComponent_1_4.check_formatDay(currVal_10,throwOnChange,false);
    const currVal_11:any = this.context.formatMonth;
    this._DatePickerInnerComponent_1_4.check_formatMonth(currVal_11,throwOnChange,false);
    const currVal_12:any = this.context.formatYear;
    this._DatePickerInnerComponent_1_4.check_formatYear(currVal_12,throwOnChange,false);
    const currVal_13:any = this.context.formatDayHeader;
    this._DatePickerInnerComponent_1_4.check_formatDayHeader(currVal_13,throwOnChange,false);
    const currVal_14:any = this.context.formatDayTitle;
    this._DatePickerInnerComponent_1_4.check_formatDayTitle(currVal_14,throwOnChange,false);
    const currVal_15:any = this.context.formatMonthTitle;
    this._DatePickerInnerComponent_1_4.check_formatMonthTitle(currVal_15,throwOnChange,false);
    const currVal_16:any = this.context.onlyCurrentMonth;
    this._DatePickerInnerComponent_1_4.check_onlyCurrentMonth(currVal_16,throwOnChange,false);
    const currVal_17:any = this.context.shortcutPropagation;
    this._DatePickerInnerComponent_1_4.check_shortcutPropagation(currVal_17,throwOnChange,false);
    const currVal_18:any = this.context.customClass;
    this._DatePickerInnerComponent_1_4.check_customClass(currVal_18,throwOnChange,false);
    const currVal_19:any = this.context.monthColLimit;
    this._DatePickerInnerComponent_1_4.check_monthColLimit(currVal_19,throwOnChange,false);
    const currVal_20:any = this.context.yearColLimit;
    this._DatePickerInnerComponent_1_4.check_yearColLimit(currVal_20,throwOnChange,false);
    const currVal_21:any = this.context.dateDisabled;
    this._DatePickerInnerComponent_1_4.check_dateDisabled(currVal_21,throwOnChange,false);
    const currVal_22:any = this.context.initDate;
    this._DatePickerInnerComponent_1_4.check_initDate(currVal_22,throwOnChange,false);
    const currVal_23:any = this.context.activeDate;
    this._DatePickerInnerComponent_1_4.check_activeDate(currVal_23,throwOnChange,false);
    this._DatePickerInnerComponent_1_4.detectChangesInternal(this,this._el_1,throwOnChange);
    this._DayPickerComponent_3_4.detectChangesInternal(this,this._el_3,throwOnChange);
    this._MonthPickerComponent_5_4.detectChangesInternal(this,this._el_5,throwOnChange);
    this._YearPickerComponent_7_4.detectChangesInternal(this,this._el_7,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
  private _handle_update_1_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onUpdate($event)) !== false);
    return (true && pd_0);
  }
  private _handle_selectionDone_1_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onSelectionDone($event)) !== false);
    return (true && pd_0);
  }
}

...
gulp.task('build.e2e', function (done) {
    return runSequence('clean.e2e', 'build.assets.dev', 'build.js.e2e', 'build.index.dev', done);
});
// --------------
// Build prod.
gulp.task('build.prod', function (done) {
    return runSequence('clean.prod', 'build.assets.prod', 'build.html_css', 'build.fonts', 'sample.task', 'copy.js.prod', 'build.js.prod', 'build.bundles', 'build.bundles.app', 'build.index.prod', done);
});
// --------------
// Build test.
gulp.task('build.test', function (done) {
    return runSequence('clean.dev', 'build.assets.dev', 'build.fonts', 'build.js.test', 'build.index.dev', done);
});
// --------------
// Build test watch.
